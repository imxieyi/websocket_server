CREATE DATABASE  IF NOT EXISTS `amt_imgmark` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `amt_imgmark`;
-- MySQL dump 10.13  Distrib 5.7.9, for Win64 (x86_64)
--
-- Host: localhost    Database: amt_imgmark
-- ------------------------------------------------------
...
-- Dump completed on 2016-08-07 23:40:57
